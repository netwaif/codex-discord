...
test('rolloutFromOpenFiles: /proc fd·lsof 출력에서 롤아웃 경로와 세션 ID를 뽑는다', async () => {
  ...
  assert.deepEqual(rolloutFromOpenFiles(lsof), { file: '/Users/t/.codex/sessions/2026/09/11/rollout-2026-09-11T10-00-00-0195aaaa-bbbb-7ccc-8ddd-eeeeeeeeeeee.jsonl', sid: '0195aaaa-bbbb-7ccc-8ddd-eeeeeeeeeeee' });   // lsof -Fn: 'n' 필드 문자 제거
